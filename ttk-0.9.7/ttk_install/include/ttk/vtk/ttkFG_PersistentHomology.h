...
class ttkFG_PersistentHomology
  ...
  public:
    ...
    vtkSetMacro(holes1, bool);
    vtkGetMacro(holes1, bool);

    vtkSetMacro(holes2, bool);
    vtkGetMacro(holes2, bool);
  ...
  protected:
    ...
    void out1Cycles(vtkDataArray *inputScalarField, Triangulation* triangulation, vtkDataSet* output, vtkDataSet* output1);
    void out2Cycles(vtkDataArray *inputScalarField, Triangulation* triangulation, vtkDataSet* output, vtkDataSet* output1);
